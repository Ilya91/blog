<h2>Редактирование статьи: <?= $news->title ?></h2>
<div class="col-md-6">
    ...
    <form class="form-horizontal" method="post">
        <fieldset>
            ...
            <div class="form-group">
                ...
                <div class="">
                    <input id="textinput" name="author" type="text" value="<?= $news->author ?>" placeholder="author"
                           class="form-control input-md">
                </div>
            </div>
            ...
            <div class="form-group">
                <div class="">
                    <button id="button1id" name="edit" class="btn btn-success">Edit</button>
